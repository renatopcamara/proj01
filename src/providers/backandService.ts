...
export class BackandService {
    ...
    private app_name:string = 'Proj01';
    private signUpToken: string = 'd28a16f6-ecbc-46f1-a7be-efbdc45f1e30';
    private anonymousToken: string = 'c406c73c-3688-4828-a734-004ac04b04d0';
